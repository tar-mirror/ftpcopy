...
extern int dns_ip64_qualify_rules(stralloc *,stralloc *,const stralloc *,const stralloc *);
extern int dns_ip64_qualify(stralloc *,stralloc *,const stralloc *);

extern int dns_name6_domain(char *,char *);
extern int dns_name6(stralloc *out,char *);
